...
let CountdownComponent = class CountdownComponent {
    ...
    missionCountDown(cdNumber, end) {
        ...
        cdNumber = setInterval(() => {
            ...
            let getDays = countdownSelect.getElementsByClassName('days')[0];
            let getHours = countdownSelect.getElementsByClassName('hours')[0];
            let getMinutes = countdownSelect.getElementsByClassName('minutes')[0];
            let getSeconds = countdownSelect.getElementsByClassName('seconds')[0];
        ...
        // if (this.child.isLaunch == true && this.child.isDone == true) {
        //   this.missionService.endOfMission(this.child).subscribe(res => {
        //     console.log("result of endOfMission", res)
        //   });
        // }
    }
...
tslib_1.__decorate([
    Input()
], CountdownComponent.prototype, "child", void 0);
tslib_1.__decorate([
    ViewChild('divSelected', { static: false })
], CountdownComponent.prototype, "divRef", void 0);
